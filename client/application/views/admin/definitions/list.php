...
<?=form_open('admin/definitions/index', array('class' => 'form-search'));?>
...
<dt><?=$def['entry_word'];?></dt>
	<?php endif; ?>
<dd><strong><?=$last_count;?>.</strong>&nbsp;&nbsp;<i><?=$def['part_of_speech'];?></i>&nbsp;&nbsp;<?=$def['definition'];?> <i>&mdash; <?=$def['author'];?></i> [<a href="<?=site_url('/admin/definitions/edit/'.$def['id']);?>">edit</a>]</dd>
